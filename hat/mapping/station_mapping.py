...
def process_station_data(station,
    ...
    if near_area_diff >= min_area_diff:
        ...
        optimum_lat_idx, optimum_lon_idx = find_best_matching_grid(lat, lon, latitudes, longitudes, nc_data, station_area, max_neighboring_cells, max_area_diff)
        ...
        optimum_distance_km = calculate_distance(lat, lon, latitudes[optimum_lat_idx], longitudes[optimum_lon_idx])
    else:
